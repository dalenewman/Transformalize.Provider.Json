...
REM nuget push "c:\temp\modules\Transformalize.Transform.Json.0.6.11-beta.nupkg" -source https://api.nuget.org/v3/index.json
REM nuget push "c:\temp\modules\Transformalize.Transform.Json.Autofac.0.6.11-beta.nupkg" -source https://api.nuget.org/v3/index.json
